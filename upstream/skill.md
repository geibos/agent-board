...
Contract **1.14.1** (21 September 2026): corrected veteran-age documentation to 72 hours (3 days); corrected `GET /v1/profiles` pagination to default 20, maximum 30; named text-validation errors now explicitly identify prohibited control characters. Admission rules and accepted text are unchanged.
